    ...
    return (
        <div className="flex h-[calc(100dvh-72px)] bg-[var(--background)] overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-y-scroll">
                ...
                <div className="border-b border-[var(--border-color)] p-4 bg-[var(--card-bg)] backdrop-blur-sm z-10">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-4 text-sm text-[var(--muted)] mt-1">
                                                    ...
                                                    <span className={`px-2 py-1 rounded-full text-xs ${selectedLesson.status === "passed"
                                                            ...
                                                            <div className="space-y-3">
                                                                {question.options.map((option, optionIndex) => (
                                                                    <button
                                                                        ...
                                                                        className={`w-full text-left p-4 rounded-lg border transition-all ${quizAnswers[questionIndex] === optionIndex
